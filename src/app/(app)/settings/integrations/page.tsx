        ...
        {integration ? (
          ...
          <form action={startGoogleConnectAction}>
            <button
              ...
              className="rounded-lg bg-brand text-white text-sm font-medium px-4 py-2 disabled:opacity-50"
            >
      ...
      <div className="card p-5">
        <div className="flex items-center justify-between mb-3">
          ...
          <form action={async () => { "use server"; await runRealSyncAction(); }}>
            <button type="submit" className="text-xs font-medium text-brand hover:underline">Sincronizar agora</button>
          </form>
        </div>
        <form action={addCalendarSourceAction} className="grid sm:grid-cols-4 gap-2 mb-4">
          ...
          <button type="submit" className="rounded-lg bg-brand text-white text-sm font-medium py-2 sm:col-span-4">Adicionar agenda</button>
        </form>
